                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <form action="{{ route('#updateItem') }}" class="form-horizontal" method="POST">
                                    @csrf
                                    <input type="text" style="display: none" class="form-control" value="{{ $item->item_id }}" name="itemId">

                                    <div class="form-group row mb-3">
                                        <label for="" class="col-sm-3 col-form-label">Name</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" value="{{ old('name', $item->item) }}" name="name">
                                        </div>
                                    </div>
